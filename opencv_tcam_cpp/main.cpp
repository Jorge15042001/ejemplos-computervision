...
int main(int argc, char **argv)
{
    ...
    try
    {
        ...
        cam.set_property("ExposureTime",3333.0 );

        //get camera parameters
        double exp_time = 0.;
        cam.get_property("ExposureTime",exp_time);
        std::cout<<"ExposureTime: "<<exp_time<<std::endl;
    ...
    if( cam.start() )
    {
        std::cout<<"Inpute 'p' to take a picture 'q' to exit"<<std::endl;
        //main loop
        while(true){
